	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				...
				<button class="btn btn-blue-light btn-block col-md-2 float-right" type="button" id="new_borrower"><i class="fa fa-plus"></i> New Borrower</button>
			</div>
			<div class="card-body">
				<table class="table table-bordered" id="borrower-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">Current Debt</th>
						...
						$i = 1;
						 ...
						 <tr>
						 	...
						 	<td class="text-center">
						 			<button class="btn btn-outline-info btn-sm edit_borrower" type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></button>
