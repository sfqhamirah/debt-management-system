...
<style>
		.btn-blue-light {
 		background-color: #96C1C1 !important; /* Cream color */
		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Debt List</b>
					<button class="btn btn-blue-light btn-sm btn-block col-md-2 float-right" type="button" id="new_application"><i class="fa fa-plus"></i> Create New Application</button>
				</large>
				...
				<table class="table table-bordered" id="loan-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">Debt Details</th>
						...
						<?php
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Debt type :<b><?php echo $type_arr[$row['loan_type_id']] ?></small></b></p>
							...
							<style>
								  .badge-orange {
    							   background-color: #FCBB49 !important; /* Cream color */
							...
							<style>
								  .badge-baby-blue {
    							   background-color: #B3D8C9 !important; /* Cream color */
    							   color: #000000 !important; /* Black text color */
  									}
							</style>
							 ...
							 <style>
								  .badge-light-green {
    							   background-color: #ADDEAC !important; /* Cream color */
    							   color: #000000 !important; /* Black text color */
  									}
							 </style>
						 	...
						 	<td class="text-center">
						 		<?php if($row['status'] == 0): ?>
						 			<span class="badge badge-orange">For Approval</span>
						 		<?php elseif($row['status'] == 1): ?>
						 			<span class="badge badge-primary">Approved</span>
					 			<?php elseif($row['status'] == 2): ?>
						 			<span class="badge badge-baby-blue">Released</span>
					 			<?php elseif($row['status'] == 3): ?>
						 			<span class="badge badge-light-green">Completed</span>
					 			<?php elseif($row['status'] == 4): ?>
						 			<span class="badge badge-danger">Denied</span>
						 		<?php endif; ?>
						 	</td>
						 	<td class="text-center">
						 			<button class="btn btn-outline-info btn-sm edit_loan" type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></button>
...
<script>
	...
	$('#new_application').click(function(){
		uni_modal("New Debt Application","manage_loan.php",'mid-large')
	})
