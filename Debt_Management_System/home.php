...
<div class="containe-fluid">
	...
	<div class="row mt-3 ml-3 mr-3">
			...
			<div class="card">
                ...
                <style>
                    .bg-cream-brown {
                    background-color: #C89E69 !important; /* Light red-pink color */
                     }
                </style>
				<hr>
				<div class="row ml-2 mr-2">
				<div class="col-md-3">
                        <div class="card bg-cream-brown text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                                        <div class="text-white small">Payments Today</div>
                ...
                <style>
                    .bg-brown-pink {
                    background-color: #CDA992 !important; /* Light red-pink color */
                     }
                </style>
                <div class="col-md-3">
                        <div class="card bg-brown-pink text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                   ...
                   <style>
                      .bg-brown-purple {
                      background-color: #C2B1AB !important; 
                      }
                  </style>
                  <div class="col-md-3">
                        <div class="card bg-brown-purple text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                                        <div class="text-white-75 small">Active Debts</div>
                                        <div class="text-lg font-weight-bold">
                                        	<?php 
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="index.php?page=loans">View Debt List</a>
                                <div class="small text-white">
                                	<i class="fas fa-angle-right"></i>
                                </div>
                            </div>
                    ...
                    <style>
                      .bg-brown-yellow {
                      background-color: #EAD092 !important; /* Light red-pink color */
                      }
                    </style>

                     <div class="col-md-3">
                        <div class="card bg-brown-yellow text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
