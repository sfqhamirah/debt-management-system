...
<style>
		.bg-brown {
 		background-color: #AE8665 !important; /* Cream color */
    	color: #FFFFFF !important; /* text color */
  		}
</style>
<nav id="sidebar" class='mx-lt-5 bg-brown' >
		
		<div class="sidebar-list">

				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Home</a>
				<a href="index.php?page=loans" class="nav-item nav-loans"><span class='icon-field'><i class="fa fa-file-invoice-dollar"></i></span> Debts</a>	
				...
				<a href="index.php?page=loan_type" class="nav-item nav-loan_type"><span class='icon-field'><i class="fa fa-th-list"></i></span> Debt Types</a>		
